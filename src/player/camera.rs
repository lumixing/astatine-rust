...
use crate::world::chunks::{BLOCK_SIZE, HALF_BLOCK_SIZE};
...
pub fn spawn_camera(mut commands: Commands) {
    ...
    camera_bundle.camera_2d.clear_color =
        ClearColorConfig::Custom(Color::rgb(71. / 255., 209. / 255., 1.));
...
pub fn update_cursor_position(
    ...
    let tile_cursor_pos = world_cursor_pos.as_ivec2().add(HALF_BLOCK_SIZE).div(BLOCK_SIZE);
